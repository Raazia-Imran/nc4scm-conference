export const trackGroups=[
  {number:'01',title:'Green Construction Materials',topics:[
    ['01','Low-Carbon Cementitious Materials'],
    ['02','Minerals & Chemical Admixtures'],
    ['03','Waste-Derived Construction Materials']
  ]},
  {number:'02',title:'Sustainable Construction',topics:[
    ['04','Performance & Durability of Sustainable Structures'],
    ['05','Modelling, Simulation & Digital Engineering'],
    ['06','Sustainable Structural Design & Construction Practices']
  ]},
  {number:'03',title:'Case Studies & Best Practices',topics:[
    ['07','Industrial Decarbonisation & Best Practices'],
    ['08','Policy, Standards & Green Construction'],
    ['09','Sustainable Cities, Climate Action & Case Studies']
  ]}
] as const;
